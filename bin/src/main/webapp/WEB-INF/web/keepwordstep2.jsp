										...
										<div class="form-wrap">
											<form>
												<div class="row">
													<div class="col-lg-12">
														<div class="mt-25">
															<input type="checkbox" checked class="js-switch js-switch-1"  data-color="#fd7397" data-size="small"/>
															<input type="checkbox" checked class="js-switch js-switch-1"  data-color="#fd7397"/>
															<input type="checkbox" checked class="js-switch js-switch-1"  data-color="#fd7397" data-size="large"/>
														</div>
													</div>
												</div>
											</form>
										...
										<div class="form-wrap">
											<form>
												<div class="row">
													<div class="col-lg-12">
														<div class="mt-25">
															<input type="checkbox" class="js-switch js-switch-1"  data-color="#4aa23c" data-secondary-color="#f8b32d" />
															<input type="checkbox" class="js-switch js-switch-1"  data-color="#f8b32d"  data-secondary-color="#4aa23c" />
														</div>
													</div>
												</div>
											</form>
