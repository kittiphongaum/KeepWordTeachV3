		...
		<div class="wrapper  theme-3-active pimary-color-blue">
			...
			<div class="fixed-sidebar-left">
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						<a class="active" href="./history-add" data-toggle="collapse" data-target="#app_dr">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="panel panel-default card-view ">
									...
									<div class="panel-heading">
										<div class="pull-left">
											<h6 class="panel-title txt-dark">ครุศาสตร์</h6>
										</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="panel panel-default card-view ">
									...
									<div class="panel-heading">
										<div class="pull-left">
											<h6 class="panel-title txt-dark">วิทยาศาสตร์</h6>
										</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="panel panel-default card-view ">
									...
									<div class="panel-heading">
										<div class="pull-left">
											<h6 class="panel-title txt-dark">มนุษย์ศาสตร์และสังคมศาสตร์</h6>
										</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="panel panel-default card-view ">
									...
									<div class="panel-heading">
										<div class="pull-left">
											<h6 class="panel-title txt-dark">วิทยาการจัดการ</h6>
										</div>
					...
					<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="panel panel-default card-view ">
										...
										<div class="panel-heading">
											<div class="pull-left">
												<h6 class="panel-title txt-dark">เทคโนโลยีอุตสาหกรรม</h6>
											</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="panel panel-default card-view ">
										...
										<div class="panel-heading">
											<div class="pull-left">
												<h6 class="panel-title txt-dark">เทคโนโลยีการเกษตร</h6>
											</div>
						...
						<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="panel panel-default card-view ">
											...
											<div class="panel-heading">
												<div class="pull-left">
													<h6 class="panel-title txt-dark">คณะพยาบาลศาสตร์</h6>
												</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="panel panel-default card-view ">
											...
											<div class="panel-heading">
												<div class="pull-left">
													<h6 class="panel-title txt-dark">อาจารพิเศษ</h6>
												</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="panel panel-default card-view ">
								...
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">ประวัติการเบิก</h6>
									</div>
