																				...
																				<div class="col-md-3 col-xs-12">
																						<div class="form-group">
																								<div class="row">
																									...
																									<div class="col-sm-9">
																										<input type="text" class="form-control" id="exampleInputuname_3" placeholder="">
																									</div>
																								</div>
																							</div>
																				</div>
																		...
																		<div class="form-group">
																			<div class="row">
																				...
																				<div class="col-md-3 col-xs-12">
																						<div class="form-group">
																								<div class="row">
																									<label for="exampleInputuname_3" class="col-sm-6 control-label">ปีการศึกษา</label>
																									<div class="col-sm-6">
																										<input type="text" class="form-control" id="" placeholder="">
																									</div>
																								</div>
														...
														<div class="col-sm-12">
															<div class="panel panel-default card-view">
																...
																<div class="panel-wrapper collapse in">
																							...
																							<div class="col-sm-9">
																								<div class="input-group">
																									...
																									<span class="input-group-btn">
																										<button type="button" class="btn btn-success btn-anim"><i class="icon-rocket"></i><span class="btn-text">ค้นหา</span></button>
																									</span>
																								</div>
																							</div>
																						</div>
																	...
																	<div class="form-group">
																		<div class="row">
																			<div class="col-md-4 col-xs-12">
																				<div class="form-group">
																					<div class="row">
																						<label class="control-label mb-10 col-sm-6" for="firstName ">ภาคทฤษฎี</label>
																						<div class="col-sm-6">
																			...
																			<div class="col-md-4 col-xs-12">
																				<div class="form-group">
																					<div class="row">
																						<label class="control-label mb-10 col-sm-6" for="lastName">ภาคปัฏิบัติ</label>
																						<div class="col-sm-6">
																							<input id="firstName" type="text" name="first_name" class="form-control required " value="" />
																						</div>
																					</div>
																			...
																			<div class="col-md-4 col-xs-12">
																				<div class="form-group">
																					<div class="row">
																						<label class="control-label mb-10 col-sm-4" for="lastName">ห้อง</label>
																						<div class="col-sm-8">
																			...
																			<div class="col-md-4 col-xs-12">
																				<div class="form-group">
																					<div class="row">
																						...
																						<div class="col-sm-6">
																							<input id="lastName" type="text" name="last_name" class="form-control required" value="" /></div>
																					</div>
																				</div>
																			</div>
																			<div class="col-md-4 col-xs-12">
																	...
																	<a type="submit" class="btn btn-primary pull-right" onclick="insertTeachingfrom()">
																			<h4>เพิ่มวิชาสอน</h4>
																	</a>
																</div>
																</div>
												...
												<div class="col-sm-12">
													<div class="form-wrap">
														...
														<div class="form-group">
															...
															<input id="postalCode" type="text" name="zip_code" data-mask="99999-9999" class="form-control required"
															 value="" />
														</div>
														<div class="form-group">
															<label class="control-label mb-10" for="phoneNumber">phone number:</label>
															<input type="text" id="phoneNumber" data-mask="+40 999 999 999" name="phone_number" class="form-control required"
															 value="" />
														</div>
														<div class="form-group">
