    ...
    <div class="wrapper  theme-1-active pimary-color-blue">
						...
						<li class="dropdown auth-drp">
								<li class="dropdown auth-drp">
										...
										<ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
											<li>
												<a href="profile.html"><i class="zmdi zmdi-account"></i><span>บันชีผู้ใช้</span></a>
											</li>
											<li>
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a class="active" href="./index1" data-toggle="collapse" data-target="#dashboard_dr" ><div class="pull-left"><i class="ti-layout-grid2  mr-20"></i><span class="right-nav-text">Dashboard</span></div><div class="clearfix"></div></a>
					...
					<div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                        <div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">ตารางสอน</h6>
								</div>
							...
							<div class="panel-wrapper collapse in">
                                <div class="panel-body">
									...
									<div id="" class="" style="height:324px;"></div>
								</div>
							</div>
                        </div>
					</div>
